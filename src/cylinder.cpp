...
auto Cylinder::set_colour_imple(Colour const new_colour) -> void
{
    switch (new_colour)
    {
        case Colour::red:
...
auto Cylinder::get_colour_imple(void) const -> Colour
{
...
auto Cylinder::get_location_imple(void) const -> std::tuple<XAxis, YAxis, ZAxis>
{
    return std::tuple{
...
auto Cylinder::move_to_imple(XAxis const x) -> void
{
...
auto Cylinder::move_to_imple(YAxis const y) -> void
{
...
auto Cylinder::move_to_imple(ZAxis const z) -> void
{
...
auto Cylinder::move_to_imple(XAxis const x, YAxis const y, ZAxis const z) -> void
{
    shapes_list_ptr_->at(0).pose.position.x = x.get_value();
    shapes_list_ptr_->at(0).pose.position.y = y.get_value();
    shapes_list_ptr_->at(0).pose.position.z = z.get_value();
...
auto Cylinder::get_display_markers_imple(void)
...
auto Cylinder::get_orientation_imple(void) const -> ZAxis
{
