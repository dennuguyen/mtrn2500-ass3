...
auto Cube::resize_imple(AllAxis const new_size) -> void
{
    size_ = new_size;
...
auto Cube::set_colour_imple(Colour const new_colour) -> void
{
    switch (new_colour)
    {
        case Colour::red:
...
auto Cube::get_colour_imple(void) const -> Colour
{
...
auto Cube::get_location_imple(void) const -> std::tuple<XAxis, YAxis, ZAxis>
{
    return std::tuple{
...
auto Cube::move_to_imple(XAxis const x) -> void
{
...
auto Cube::move_to_imple(YAxis const y) -> void
{
...
auto Cube::move_to_imple(ZAxis const z) -> void
{
...
auto Cube::get_display_markers_imple(void)
...
auto Cube::get_orientation_imple(void) const -> ZAxis
{
